...
function printStrings(array) {
  ...
  // Видаляємо пробіли з рядка за допомогою trim()
  str = str.trim();
  // Повторюємо рядок двічі за допомогою repeat(2)
...
function addTenToEach(array) {
  ...
  for (const index in array) {
    // Додаємо до поточного елемента 10 та зберігаємо результат у новий масив
